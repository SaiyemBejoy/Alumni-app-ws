...
import com.example.web.ui.model.request.AlumniLoginRequestModel;
import com.fasterxml.jackson.databind.ObjectMapper;

import io.jsonwebtoken.Jwts;
import io.jsonwebtoken.SignatureAlgorithm;

public class AuthenticationFielter extends UsernamePasswordAuthenticationFilter {

	private final AuthenticationManager authenticationManager;

	public AuthenticationFielter(AuthenticationManager authenticationManager) {
	...
	public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			AlumniLoginRequestModel creds = new ObjectMapper().readValue(request.getInputStream(),
					AlumniLoginRequestModel.class);
